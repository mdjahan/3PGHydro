#' Run 3PG-Hydro
#'
#' 3PG-Hydro is an update of the original 3PG: calculates in daily timesteps, integrates
#' a soil-water-model with 2 soil layers & a snow routine. Further information can be found in
#' Yousefpour & Djahangard (2021), DOI:10.3390/f12121729
#' Thanks to Anja Nölte for 3PG R-Code 
#' Description: ...
